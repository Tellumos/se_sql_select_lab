...
# STEP 5
# Replace None with your code
df_executive = pd.read_sql("""SELECT jobTitle, CASE WHEN jobTitle = "President" OR jobTitle = "VP Sales" OR jobTitle = "VP Marketing" THEN "Executive" ELSE "Not Executive" END AS role FROM employees""", conn)
